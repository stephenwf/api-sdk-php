...
final class UnknownReferenceTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $reference = new UnknownReference('id', $date = new ReferenceDate(2000), null,
            [new PersonAuthor(new PersonDetails('preferred name', 'index name'))], false, 'title');
    ...
    {
        $with = new UnknownReference('id', new ReferenceDate(2000), 'a',
            [new PersonAuthor(new PersonDetails('preferred name', 'index name'))], false, 'title');
        $withOut = new UnknownReference('id', new ReferenceDate(2000), null,
            [new PersonAuthor(new PersonDetails('preferred name', 'index name'))], false, 'title');
    ...
    {
        $with = new UnknownReference('id', new ReferenceDate(2000), null,
