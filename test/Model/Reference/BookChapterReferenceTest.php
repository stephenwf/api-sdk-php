...
final class BookChapterReferenceTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $reference = new BookChapterReference('id', new ReferenceDate(2000), null,
    ...
    {
        $reference = new BookChapterReference('id', $date = new ReferenceDate(2000), null,
            [new PersonAuthor(new PersonDetails('author preferred name', 'author index name'))], false,
            [new PersonAuthor(new PersonDetails('editor preferred name', 'editor index name'))], false, 'chapter title',
            'book title', new Place(null, null, ['publisher']), new StringReferencePage('foo'));
    ...
    {
        $with = new BookChapterReference('id', new ReferenceDate(2000), 'a',
            [new PersonAuthor(new PersonDetails('author preferred name', 'author index name'))], false,
            [new PersonAuthor(new PersonDetails('editor preferred name', 'editor index name'))], false, 'chapter title',
            'book title', new Place(null, null, ['publisher']), new StringReferencePage('foo'));
        $withOut = new BookChapterReference('id', new ReferenceDate(2000), null,
            [new PersonAuthor(new PersonDetails('author preferred name', 'author index name'))], false,
            [new PersonAuthor(new PersonDetails('editor preferred name', 'editor index name'))], false, 'chapter title',
            'book title', new Place(null, null, ['publisher']), new StringReferencePage('foo'));
    ...
    {
        $with = new BookChapterReference('id', new ReferenceDate(2000), null,
